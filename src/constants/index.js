...
const experiences = [
  ...
  },
  {
    ...
    icon: uc,
    iconBg: "#E6DEDD",
    date: "Jan 2008 - Nov 2017",
    points: [
      "Oversee the planning and execution of events from start to finish",
      "Coordinate with clients, vendors, and internal teams to ensure smooth logistics",
      "Manage budgets, timelines, and resources effectively",
      "Supervise event staff and coordinate on-site operations",
      "Troubleshoot any issues that arise during events",
      "Ensure a seamless and exceptional event experience for attendees",
    ],
  },
];
